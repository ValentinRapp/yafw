...
const getDetectedOS = (): "mac" | "windows" | "linux" => {
		...
		<div className="flex flex-col bg-mocha-base min-h-screen text-mocha-text relative overflow-hidden">
			...
			{currentPage === "download" ? (
				<div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
					<div className="bg-mocha-surface0/60 backdrop-blur-md p-6 md:p-10 rounded-2xl border border-mocha-surface0 shadow-2xl w-full max-w-3xl transition-all">
